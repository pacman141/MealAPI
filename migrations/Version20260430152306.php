 ...
 */
final class Version20260430152306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning_recipe ADD day_of_week VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE user_name user_name VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning_recipe DROP day_of_week');
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE1359D8A214');
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE13933FE08C');
        $this->addSql('ALTER TABLE user CHANGE user_name user_name VARCHAR(50) DEFAULT NULL');
    }
}
