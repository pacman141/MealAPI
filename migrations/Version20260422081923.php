 ...
 */
final class Version20260422081923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning_recipe CHANGE planning_id planning_id INT NOT NULL, CHANGE recipe_id recipe_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning_recipe CHANGE planning_id planning_id INT DEFAULT NULL, CHANGE recipe_id recipe_id INT DEFAULT NULL');
    }
}
